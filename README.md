...
Install VSCode with with extensions like live server, prettier formatter etc,
Have a laptop as well

### Setup

Clone this repository to your desired folder:
git clone git@github.com:ismailhallirumuhammad/mobile-version-2.git
...
To navigate through the repo you type: cd finish-mobile-version-1,
...
Feel free to check the [issues page](https://github.com/ismailhallirumuhammad/finish-mobile-version-1/issues).
